        ...
        <div className="min-h-screen w-full flex flex-col gap-10 items-center justify-center px-6 py-16">
          <div className="text-center max-w-2xl">
            ...
            <h1 className="mt-6 text-4xl sm:text-5xl md:text-6xl font-bold !leading-[1.2] tracking-tight">
              Votre ticket pour le concert de Bad Nova & Minks à Maroua a bien
              été généré.
            </h1>
            <p className="mt-6 text-[17px] md:text-lg">
              Vous êtes maintenant prêt pour le concert. Téléchargez votre
              billet avec votre nom et votre QR code.
            </p>
